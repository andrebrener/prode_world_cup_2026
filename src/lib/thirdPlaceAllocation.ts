// Annexe C oficial de las "Regulations for the FIFA World Cup 26" — asignación de los
// 8 mejores terceros a sus cruces de 16avos. NO es un algoritmo: FIFA publica una tabla
// fija con las 495 combinaciones posibles de qué 8 grupos (de 12) clasifican con su tercero.
//
// Clave: combinación ORDENADA de las letras de los 8 grupos cuyo tercero clasifica (ej. "BDEFIJKL").
// Valor: slot de 1° de grupo ("1A".."1L") → letra del grupo cuyo tercero lo enfrenta en ese cruce.
// Los slots 1A/1B/1D/1E/1G/1I/1K/1L corresponden a los partidos 79/85/81/74/82/77/87/80.
//
// Generado desde la tabla oficial; verificado fila por fila contra el PDF de FIFA (495 filas).
// NO editar a mano.
